...
/// Late init car to store the instance of the [FlutterLocalNotificationsPlugin]
...
Future<void> setupFlutterLocalNotifications() async {
  ...
  /// Requesting permission on the device having SDK version 33 or more
  // await flutterLocalNotificationsPlugin
  //     .resolvePlatformSpecificImplementation<
  //         AndroidFlutterLocalNotificationsPlugin>()
  //     ?.requestPermission();

  /// Requesting permission on the ios devices
  // await flutterLocalNotificationsPlugin
  //     .resolvePlatformSpecificImplementation<
  ...
  channel = const AndroidNotificationChannel(
    'xcenter_news_default_notification_id',
    'Default Notification Channel',
    description:
        'This channel is used for Xcenter News default notifications',
